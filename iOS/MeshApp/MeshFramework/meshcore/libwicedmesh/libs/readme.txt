This file introduce the prebuild libwicedmesh.a libraires and how to integrate it.
...
1) Got to Xcode, select a Target, and go to "Build Phases" page.
2) Through left top "+" button on the page to add a new phase of "New Run Script Phase" in the drop list.
3) By default the new "Run Script" phase is at bottom.
4) Drag the new "Run Script" phase to the front of "Complie Sources" phase, so
   the "Run Script" can be executed before source code compiling and linking.
5) Expand the new "Run Script" phase, copy and paste following script code into the Shell.
