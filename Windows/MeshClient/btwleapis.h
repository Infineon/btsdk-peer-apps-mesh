...
/** @file
*
* this file contains the definitions for the BTW GATT APIs
*/
...
/*******************************************************************************
**
** Function:        BtwGattGetCharacteristicProperties
**
** Description:     This function can be used to read Get characteristic
**      properties of a specific service of a specific device
**
** Parameters:
** hReg:            Handle returned in BtwGattRegister
**
...
**
** pdwProperties:     Memory location where results will be stored.
**
** Returns          ERROR_SUCCESS on success; WinError if read fails.
**
*******************************************************************************/
DWORD WINAPI BtwGattGetCharacteristicProperties
(
    HANDLE                      hReg,               // handle of the application registration
    BLUETOOTH_ADDRESS           *pAddress,          // address of the device to read
    const GUID                  *pGuidService,      // guid of the service
    DWORD                       dwServiceInstance,  // instance of the service (usually 0)
    const GUID                  *pGuidChar,         // guid of the char
    DWORD                       dwCharInstance,     // instance of the char (usually 0)
    DWORD                       *pdwProperties      // pointer to the value to return
);
typedef DWORD (WINAPI *FP_BtwGattGetCharacteristicProperties)
(
    HANDLE                      hReg,               // handle of the application registration
    BLUETOOTH_ADDRESS           *pAddress,          // address of the device to read
    const GUID                  *pGuidService,      // guid of the service
    ...
    DWORD                       *pdwProperties      // pointer to the result
);
