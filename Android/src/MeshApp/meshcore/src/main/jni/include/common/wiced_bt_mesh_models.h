 ...
 *
 * 3. A model cannot be repeated twiced in the same element.
 *
 * @{
 */
 ...
 * @return      None
 */
void wiced_bt_mesh_model_fw_update_server_init(uint8_t element_idx, wiced_bt_mesh_fw_update_server_callback_t *p_callback, wiced_bool_t is_provisioned);
