...
/* The group occupies high 6 bits of the HCI command, the rest is the opcode itself. */
#define HCI_OGF(p)  (UINT8)((0xFC00 & (p)) >> 10)
#define HCI_OCF(p)  ( 0x3FF & (p))

/* Definitions for Link Control Commands */
/* The following opcode is used only in a command complete event for flow control */
...
/* ADV extension */
#define HCI_BLE_SET_ADV_SET_RANDOM_ADDR     (0x0035 | HCI_GRP_BLE_CMDS)
#define HCI_BLE_SET_EXT_ADV_PARAMETERS      (0x0036 | HCI_GRP_BLE_CMDS)
...
#define HCI_BLE_READ_MAX_ADV_DATA_LEN       (0x003A | HCI_GRP_BLE_CMDS)
#define HCI_BLE_READ_NUM_OF_SUPPORTED_ADV_SETS   (0x003B | HCI_GRP_BLE_CMDS)
#define HCI_BLE_REMOVE_ADV_SET              (0x003C | HCI_GRP_BLE_CMDS)
#define HCI_BLE_CLEAR_ADV_SETS              (0x003D | HCI_GRP_BLE_CMDS)
#define HCI_BLE_SET_PERIODIC_ADV_PARAMS     (0x003E | HCI_GRP_BLE_CMDS)
#define HCI_BLE_SET_PERIODIC_ADV_DATA       (0x003F | HCI_GRP_BLE_CMDS)
#define HCI_BLE_SET_PERIODIC_ADV_ENABLE     (0x0040 | HCI_GRP_BLE_CMDS)
#define HCI_BLE_SET_EXT_SCAN_PARAMETERS     (0x0041 | HCI_GRP_BLE_CMDS)
#define HCI_BLE_SET_EXT_SCAN_ENABLE         (0x0042 | HCI_GRP_BLE_CMDS)
#define HCI_BLE_EXT_CREATE_CONNECTION       (0x0043 | HCI_GRP_BLE_CMDS)
#define HCI_BLE_PERIODIC_ADV_CREATE_SYNC    (0x0044 | HCI_GRP_BLE_CMDS)

#define HCI_BLE_PERIODIC_ADV_CREATE_SYNC_CANCEL (0x0045 | HCI_GRP_BLE_CMDS)
#define HCI_BLE_PERIODIC_ADV_TERMINATE_SYNC     (0x0046 | HCI_GRP_BLE_CMDS)
#define HCI_BLE_ADD_DEV_TO_PERIODIC_ADV_LIST    (0x0047 | HCI_GRP_BLE_CMDS)
#define HCI_BLE_REMOVE_DEV_FROM_PERIODIC_ADV_LIST   (0x0048 | HCI_GRP_BLE_CMDS)
#define HCI_BLE_CLEAR_PERIODIC_ADV_LIST             (0x0049 | HCI_GRP_BLE_CMDS)
#define HCI_BLE_READ_PERIODIC_ADV_LIST_SIZE         (0x004A | HCI_GRP_BLE_CMDS)
...
/* High Duty-Cycle Directed Adv state is supported. 0x0000000000000008 */
...
/* High Duty-Cycle Directed ADv and Passive Scanning state combination is supported. 0x0000000000000800 */
...
/* High Duty-Cycle Directed ADv and ACtive Scanning State combination is supported. 0x0000000000008000 */
...
/* Initiating State and Master Role combination is supported.
...
/* Connectable Advertising State and Initiating state combination is supported. 0x0000000100000000 */
...
/* High Duty-Cycle Directed Advertising state and Initiating State combination is supported. */
...
/* Low Duty-Cycle Directed Advertising state and Initiating state combination is supported.*/
...
/* Connectable Advertising state and Master role combination is supported.*/
...
/* High Duty-Cycle Directed Advertising state and Master role combination is supported.*/
...
/* Low Duty-Cycle Directed Advertising state and Master role combination is supported.*/
...
/* Connectable Advertising state and Slave role combination is supported. */
...
/* High Duty-Cycle Directed Advertising state and slave role combination is supported.*/
...
/* Low Duty-Cycle Directed Advertising state and Slave role combination is supported.*/
...
/* Initiating state and Slave Role combination is supported.
   Master Role and Slave Role combination is also supported. */
...
/* Removed from spec */
#define HCI_GENERIC_AMP_LINK_KEY_NOTIF_EVT  0x3E
...
#define HCI_BLE_PERIODIC_ADV_SYNC_ESTABLISHED_EVT   0x0e
#define HCI_BLE_PERIODIC_ADV_REPORT_EVT             0x0f
#define HCI_BLE_PERIODIC_SYNC_LOST_EVT              0x10
#define HCI_BLE_EXT_SCAN_TIMEOUT_EVT                0x11
...
#define HCI_NAP_TRACE_EVT                   0xFF  /* Was - define 0xFE, 0xFD,
                                                     changed to 0xFF
                                                     because of the conflict w/ TCI_EVT
                                                     and per specification compliant */
...
/* 0x0000000000004000 Triggered Clock Capture Event
   ...
   0x0000000000400000 Inquiry Response Notification Event  The mask-off of this event is not processed on the host.
...
/* The pcket type should be one of the valid but at least one should be specified for 1.2 */
...
/* Allows switching by default, because the host cannot allow that
   until it creates the connection. */
#define HCI_DEFAULT_POLICY_SETTINGS     HCI_DISABLE_ALL_LM_MODES

/* Filters that sent in the Set filter command */
...
#define HCI_DO_AUTO_ACCEPT_CONNECT      2   /* Role switch is disabled */
#define HCI_DO_AUTO_ACCEPT_CONNECT_RS   3   /* Role switch is enabled (1.1 errata 1115) */
...
/* Parameter for inquiryscan window is passed to LC and kept in slots */
...
/* Define broadcast data types is passed in the HCI data packet */
...
/* Reads Local Version HCI Version return values (Command Complete Event) */
#define HCI_VERSION_1_0B                0x00
#define HCI_VERSION_1_1                 0x01

/* Defines an invalid value for a handle */
#define HCI_INVALID_HANDLE              0xFFFF

/* Defines max ammount of data in the HCI command. */
#define HCI_COMMAND_SIZE        255

/* Defines the preamble length for all HCI commands.
...
/* The local Bluetooth controller ID for AMP HCI */
#define LOCAL_BR_EDR_CONTROLLER_ID      0

/* The controller ID types for AMP HCI */
...
/* The array sizes for MWS co-existence commands. */
#define HCI_MWS_NUM_PERIODS_SUPPORTED                   32  /* for HCI_SET_EXTERNAL_FRAME_CONFIGURATION */
#define HCI_MWS_NUM_SCAN_FREQS_SUPPORTED                8   /* for HCI_SET_MWS_SCAN_FREQUENCY_TABLE */
#define HCI_MWS_PATTERNS_NUM_INTERVS_SUPPORTED          16  /* for HCI_SET_MWS_PATTERN_CONFIGURATION */
#define HCI_MWS_NUM_TRANSPS_SUPPORTED                   10  /* for HCI_GET_MWS_TRANS_LAYER_CFG */
#define HCI_MWS_NUM_BAUD_RATES_ON_ONE_TRANSP_SUPPORTED  20  /* for HCI_GET_MWS_TRANS_LAYER_CFG */
...
/* LE 2M PHY feature: bit 8 */
#define HCI_LE_FEATURE_2M_PHY_MASK      0x01
#define HCI_LE_FEATURE_2M_PHY_OFF       1
#define HCI_LE_2M_PHY_SUPPORTED(x) ((x)[ HCI_LE_FEATURE_2M_PHY_OFF] & HCI_LE_FEATURE_2M_PHY_MASK)

/* Stable Modulation Index - Transmitter feature: bit 9 */
//Todo

/* Stable Modulation Index - Receiver feature: bit 10 */
//Todo

/* LE Coded PHY(for LE long range) feature: bit 11 */
#define HCI_LE_FEATURE_CODED_PHY_MASK       0x08
#define HCI_LE_FEATURE_CODED_PHY_OFF        1
#define HCI_LE_CODED_PHY_SUPPORTED(x) ((x)[ HCI_LE_FEATURE_CODED_PHY_OFF] &HCI_LE_FEATURE_CODED_PHY_MASK)

/* LE Extended Advertising feature: bit 12 */
#define HCI_LE_FEATURE_EXTENDED_ADVERTISING_MASK       0x10
#define HCI_LE_FEATURE_EXTENDED_ADVERTISING_OFF        1
#define HCI_LE_EXTENDED_ADVERTISING_SUPPORTED(x) ((x)[ HCI_LE_FEATURE_EXTENDED_ADVERTISING_OFF] & HCI_LE_FEATURE_EXTENDED_ADVERTISING_MASK)

/* LE Periodic Advertising feature: bit 13 */
...
/* LE Power Class 1 feature: bit 15 */
//Todo
...
/* Definitions for local transactions */
