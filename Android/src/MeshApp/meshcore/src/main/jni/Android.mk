...
LOCAL_C_INCLUDES := $(wildcard $(LOCAL_PATH)/../../../../../../../../../dev-kit/baselib/20819A1/include/)
LOCAL_C_INCLUDES += $(wildcard $(LOCAL_PATH)/../../../../../../../../../dev-kit/btsdk-include/)
LOCAL_C_INCLUDES += $(wildcard $(LOCAL_PATH)/../../../../../../../../../dev-kit/baselib/20819A1/include/hal)
LOCAL_C_INCLUDES += $(wildcard $(LOCAL_PATH)/../../../../../../../../../dev-kit/baselib/20819A1/include/internal)
LOCAL_C_INCLUDES += $(wildcard $(LOCAL_PATH)/../../../../../../../../../dev-kit/baselib/20819A1/include/stack)
LOCAL_C_INCLUDES += $(wildcard $(LOCAL_PATH)/../../../../../../../../../dev-kit/libraries/btsdk-mesh/mesh_client_lib/)
...
MY_CPP_LIST += $(wildcard $(LOCAL_PATH)/../../../../../../../../../dev-kit/libraries/btsdk-mesh/mesh_client_lib/meshdb.c)
MY_CPP_LIST += $(wildcard $(LOCAL_PATH)/../../../../../../../../../dev-kit/libraries/btsdk-mesh/mesh_client_lib/wiced_bt_mesh_db.c)
MY_CPP_LIST += $(wildcard $(LOCAL_PATH)/../../../../../../../../../dev-kit/libraries/btsdk-mesh/mesh_client_lib/wiced_mesh_client.c)
