...
public class GattUtils {
    ...
    public static class RequestQueue {
        ...
        public synchronized void addWriteCharacteristic(BluetoothGatt gatt,
            ...
            mRequestQueue
                    .add(new GattRequest(GattRequest.REQUEST_WRITE_CHAR, gatt, characteristic, value));
        }
